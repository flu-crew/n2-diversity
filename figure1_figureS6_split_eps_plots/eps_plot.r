...
####################################
n2_1998_B <- read.csv("98Bdata.csv", sep = "\t", header = TRUE)
...
tiff('test.tiff', units="in", width=13.5, height=6.75, res=300, compression = 'lzw')

#############
# Figure S6 #
#############
#Plot first two as subsets #Figure S6
library(cowplot)
